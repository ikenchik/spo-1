  ...
  return (
    <div style={{ height: "100vh", padding: "20px", backgroundColor: "#232323", color: "white" }}>
      ...
      <ul style={{ listStyle: "none", padding: "0" }}>
        ...
        <li style={{ marginBottom: "10px" }}>
          <Link to="/lcpacient" style={{ color: "#87CEFA", textDecoration: "none" }}>
            Lcpacient
          </Link>
        </li>
        <li style={{ marginBottom: "10px" }}>
          <Link to="/lcdoctor" style={{ color: "#87CEFA", textDecoration: "none" }}>
            Lcdoctor
          </Link>
        </li>
        <li style={{ marginBottom: "10px" }}>
          <Link to="/signuppacnum" style={{ color: "#87CEFA", textDecoration: "none" }}>
            SignUPpacnum
          </Link>
        </li>
      </ul>
